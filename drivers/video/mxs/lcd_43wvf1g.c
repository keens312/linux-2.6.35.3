...
#define BF_PWM_PERIO 399
#endif

#ifdef CONFIG_THW480272F
...
#ifdef CONFIG_LCD_APTFT70_SERIALS
#define LCM_NAME  "APTFT70"
#define DOTCLK_FREQUENCY_HZ   24000000
#define DOTCLK_H_ACTIVE 800       // Thd
#define DOTCLK_H_PULSE_WIDTH 48   // Thpw
#define DOTCLK_HF_PORCH  40     // Thfp
#define DOTCLK_HB_PORCH  40       // Thbp = Thb - Thpw

#define DOTCLK_V_ACTIVE  480      // Tvd
#define DOTCLK_V_PULSE_WIDTH 3    // Tvpw
#define DOTCLK_VF_PORCH  13       // Tvfp
#define DOTCLK_VB_PORCH  29       // Tvbp = Tvb - Tvpw
#define LCD_PANEL_TYPE   MXS_LCD_PANEL_SYSTEM

/*179 500 */
#define BF_PWM_PERIO 189 
#endif

#ifdef CONFIG_Default_480x272
#define DOTCLK_FREQUENCY_HZ   9000000
#define DOTCLK_H_ACTIVE 480 
#define DOTCLK_H_PULSE_WIDTH  41
#define DOTCLK_HF_PORCH  5
...
//	printk("%s,%d:set the back light on \n",__func__,__LINE__);
	...
	__raw_writel(BF_PWM_PERIODn_CDIV(6) |	/* divide by 64 */
		     ...
		     BF_PWM_PERIODn_PERIOD(BF_PWM_PERIO),
			    ...
			    struct backlight_device *bd, int suspended)
{
	...
	__raw_writel(BF_PWM_ACTIVEn_INACTIVE(scaled_int*BF_PWM_PERIO/100) |
		     BF_PWM_ACTIVEn_ACTIVE(0),
		     REGS_PWM_BASE + HW_PWM_ACTIVEn(3));
	__raw_writel(BF_PWM_PERIODn_CDIV(6) |	/* divide by 64 */
