...
static struct i2c_board_info __initdata mxs_i2c_device0[] = {
...
{
    printk("i2c_device_init for ds2460\r\n");
	i2c_register_board_info(0, mxs_i2c_device0, ARRAY_SIZE(mxs_i2c_device0));
	i2c_register_board_info(1, mxs_i2c_device1, ARRAY_SIZE(mxs_i2c_device1));	//modefy by zhuguojun
}
