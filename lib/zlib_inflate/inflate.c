...
#define REG_CLR_ADDR(addr, value) \
 ...
 static void pin_gpio_set(u32 val) 
{
        if (val)
            REG_SET_ADDR(0x80018700, 1 << 21); 
        else 
            REG_CLR_ADDR(0x80018700, 1 << 21); 
}
...
//EXPORT_SYSBLE(feed_wdt);
int zlib_inflate_copy(z_streamp strm, int flush)
{
    struct inflate_state *state;
